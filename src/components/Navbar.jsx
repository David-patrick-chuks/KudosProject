...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 relative z-30">
      <div className="flex justify-between shadow-sm px-4 lg:px-[160px] py-3 bg-white items-center">
        {/* Logo */}
        <Link className="my-auto" to="/">
          <img src="images/sark-logo.png" alt="Logo" />
        ...
        {/* Hamburger Menu for Mobile/Tablet (Moved to right after the Download button) */}
        <button
          className="lg:hidden my-auto ml-4"
          onClick={toggleNav}
        >
          {/* Hamburger Icon */}
          <svg
      ...
      {isNavOpen && (
        <ul className="lg:hidden fixed top-16 right-0 w-full p-5 flex flex-col gap-4 z-50">
          {navItems}
        </ul>
      )}
    </div>
