  ...
  return (
    <div id='our-cars' className="p-4 md:p-8">
        ...
        <div className="w-full md:w-1/2 px-2 bg-green-50">
          <div className="flex flex-col md:flex-row divide-x divide-gray-300 mb-2 mt-5">
            <div className="w-full md:w-1/2 p-2 flex flex-col items-start space-y-5">
              ...
              <img src="images/220.png" alt="Dummy Image" />
          ...
          <div className="bg-green-200 border border-gray-300 p-1 rounded-md flex flex-col md:flex-row mb-5 gap-4 w-full">
            <p className='pl-2 '>
            ...
            <img src="images/Frame.png" alt="Dummy Image" className="md:w-34 md:h-12  w-1/2" />
          </div>
        </div>
      </div>
      ...
      <div id='the-benefits' className="bg-gray-100 rounded-md mt-5 py-5">
        <p className='md:pl-7 px-3 md:px-2 text-center md:text-start font-semibold'>We take care of everything, you don’t have to worry about:</p>
